 ...
 * @author Keertikeya
 */
public class AddSafeUser extends javax.swing.JFrame {

    /**
     * Creates new form AddSafeUser
     */
    public AddSafeUser() {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{
            ...
            if(pwd.getText().equals(cpwd.getText())){
                int u = stmt.executeUpdate("insert into safeuser values ('" + un.getText()+"',"
                        + "des_encrypt('" + pwd.getText() +"'), 'user');");
                ...
                JOptionPane.showMessageDialog(null, "Passwrods do not match!");
        }
        catch(Exception e){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddSafeUser.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AddSafeUser().setVisible(true);
            }
        });
    }
